...
phrases = (name) -> [
  ...
  "Wuh, I think so, #{name}, but if we didn\'t have ears, we\'d look like weasels."
  "Uh...yeah, #{name}, but where are we going to find rubber pants our size?"
  "Uh, I think so, #{name}, but balancing a family and a career...oooh, it\'s all too much for me."
  ...
  "I think so, #{name}, but if they called them sad meals, kids wouldn\'t buy them."
  "I think so, #{name}, but me and Pippi Longstocking...I mean, what would the children look like?"
